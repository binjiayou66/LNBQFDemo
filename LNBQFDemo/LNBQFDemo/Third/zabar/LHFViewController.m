...
//  二维码扫描
//
//  Created by 李洪峰 on 15/11/10.
//  Copyright (c) 2015年 LHF. All rights reserved.

#import "LHFViewController.h"

#define LINEFRAME CGRectMake(50, 50+220, 220, 2);
#define lineW  if (screen_w >=375) {_line.frame = CGRectMake(50, 70, 280, 2);}else{_line.frame = CGRectMake(50, 70, 220, 2);}
...
-(id)initWithBlock:(void(^)(NSString*str,BOOL isSuccess))a
{
    if (self=[super init]) {
        self.ScanResult=a;
    }
...
-(void)createView{
    ...
    if (self.view.frame.size.height<500) {
        ...
        bgImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 64, screen_w, self.view.frame.size.height-64-100)];
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(0, 300, screen_w, 40)];
    ...
    NSLog(@"[UIScreen mainScreen]----%@",NSStringFromCGRect([UIScreen mainScreen].bounds));
    ...
    //下方相册
    UIImageView*scanImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, bgImageView.frame.size.height+64, screen_w, 100)];
    ...
    for (int i=0; i<unSelectImageNames.count; i++) {
        ...
        button.frame=CGRectMake(screen_w/3*i, 0, screen_w/3, 100);
    ...
    //假导航
    UIImageView*navImageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, screen_w, 64)];
    navImageView.image=[UIImage imageNamed:@"qrcode_scan_bar.png"];
    navImageView.userInteractionEnabled=YES;
    [self.view addSubview:navImageView];
    UILabel*titleLabel=[[UILabel alloc]initWithFrame:CGRectMake(screen_w/2-32,20 , 64, 44)];
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:2 animations:^{
        ...
        _line.frame = CGRectMake(50, 60+220, width, 2);
...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [UIColor colorWithRed:54/255.0 green:56/255.0 blue:62/255.0 alpha:1.0];
